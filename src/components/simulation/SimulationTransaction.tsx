    ...
    return (
        <div className='content main-font'>
            ...
            <div className='flex items-center mt-2'>
                <div className='px-4 py-2 bg-secondary mr-2'>0x0000...ej22</div>
            ...
            <div className='vibranium-detail-container flex justify-between items-center p-2 mt-2'>
                <div className='flex items-center'>
                    <img src="/images/extra/image.png" alt="" className='mr-2 w-10' />
                    <div>
                        <span>h4rd c0d3d</span>
                        <div className='small-font'>h4rd c0d3d</div>
                    </div>
                </div>
